...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/facebook-post-scraper?style=social)](https://github.com/data-scrape/facebook-post-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/facebook-post-scraper?style=social)](https://github.com/data-scrape/facebook-post-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/facebook-post-scraper)](https://github.com/data-scrape/facebook-post-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/facebook-post-scraper)](https://github.com/data-scrape/facebook-post-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Facebook post scraper - extract post data, reactions, comments


<!-- SEO keywords: facebook post scraper, Facebook Post Scraper, facebook post scraper python, facebook post scraper github -->
...
- Extract Facebook post data: text, media, reactions
- Reaction breakdown (like, love, haha, wow, sad, angry)
- Comment extraction with commenter info and replies
- Share count and post timestamp
- Post type detection (text, photo, video, link)
- Media URL extraction

## 🎯 Use Cases

Track post engagement, analyze viral content, monitor sentiment.
...
```bash
pip install git+https://github.com/data-scrape/facebook-post-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/facebook-post-scraper.git
...
```python
from facebook_post_scraper import Scraper
...
```bash
python facebook_post_scraper.py --query "your-query" --output results.json
```
...
### Is Facebook Post Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/facebook-post-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/facebook-post-scraper/issues)
